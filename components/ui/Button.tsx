...
const VARIANT_STYLES: Record<Variant, string> = {
  // Solid emerald with white text — the palette's primary CTA treatment.
  primary: "bg-[var(--ink)] text-white hover:bg-[var(--ink-dark)]",
  secondary: "bg-[var(--ink)]/90 text-white hover:bg-[var(--ink)]",
